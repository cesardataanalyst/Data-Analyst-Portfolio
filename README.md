...
# Proyecto de Ventas
## Objetivo
El propósito de este análisis fue comprender el recorrido de los usuarios dentro de la plataforma de Mercado Libre, desde su primera visita hasta la finalización de una compra. Para ello, se construyó un embudo de conversión (funnel) utilizando SQL y CTEs (Common Table Expressions), permitiendo medir la cantidad de usuarios que avanzan en cada etapa del proceso de compra.
## Herramientas
Se identificaron los principales eventos que conforman el recorrido del usuario
